...
async def upload_excel(
    ...
    # Renombrar columnas
    # df, conjunto de datos , que va a nuestra base
    ...
    # codigo para que solo me tenga en cuenta el centro numero 9121
    ...
    required_fields = [
        ...
        "nombre","fecha_inicio","fecha_fin","etapa","responsable","nombre_municipio"
    ]
